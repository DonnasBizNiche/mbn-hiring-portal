 ...
 * The AI report returns only { id, answer, score, assessment } â the full
...
window.QUESTION_BANKS = {
  ...
  /* âââââââââââ SENIOR SEO STRATEGIST â 24 questions, 9 phases âââââââââââ */
  seo_strategist: {
    q1_background: {
      label: '1. Background & Experience',
      phase: 'Orientation & Philosophy',
      question: "Tell me about your strategy experience â how many years, what mix of e-commerce, local, and national work, and what size accounts you've owned end to end.",
    },
    q2_defining_success: {
    ...
    q6_keyword_mapping: {
      ...
      phase: 'Keyword â Intent â Page Mapping',
    ...
    q9_ecom_architecture: {
      ...
      question: "Northline has 4,500 SKUs. Talk me through how you'd structure category and product pages for organic, including how you'd handle faceted navigation â filters for brand, engine size, clearing width, and price. What gets indexed, what doesn't, and how do you decide?",
    },
    q10_seasonality: {
      label: '10. Seasonality & Dead SKUs',
      phase: 'E-commerce Strategy',
      question: 'Snow equipment sells September through February, mowers March through August. Every year roughly 600 SKUs are discontinued or go permanently out of stock. How do you handle both problems â the seasonal swing and the dead SKUs â from an SEO and revenue standpoint?',
    },
    q11_location_pages: {
      label: '11. Location Page Strategy',
      phase: 'Local SEO (8 Markets)',
      question: 'Northline has eight physical locations but no location pages â just a store locator with an embedded map. A previous agency proposed building 300 city pages targeting every town within driving distance of a dealer. What\'s your approach, and what do you think of that proposal?',
    },
    q12_service_overlap: {
    ...
    q22_prioritization: {
      ...
      question: "Two things. First, give me your prioritized roadmap for the first 90 days â what you do, in what order. Second: the CMO tells you he wants Northline ranking page one for 'generator' within six months because a board member asked about it. How do you handle that conversation?",
    },
    q23_executive_comms: {
  ...
  /* âââââââââââ PAID MEDIA STRATEGIST â 24 questions, 9 phases âââââââââââ */
  ppc_strategist: {
    p1_background: {
      label: '1. Background & Experience',
      phase: 'Orientation & Profitability',
      question: 'Tell me about your paid media experience â how many years, what monthly spend you have personally managed, and what mix of e-commerce versus lead generation.',
    },
    p2_defining_success: {
      label: '2. Defining Success',
      phase: 'Orientation & Profitability',
    ...
    p4_breakeven_math: {
      ...
      phase: 'Profitability Math',
      question: 'Using the margin table, what is the breakeven ROAS for each of Northline\'s three revenue lines â equipment, parts, and service? Show your working, then tell me what those numbers mean for how you would read a ROAS figure in this account.',
    },
    p5_roas_reaction: {
    ...
    p7_cpa_diagnostic: {
      ...
      phase: 'Account Structure & Diagnostics',
      question: 'Last month blended CPA rose 60% with no change in budget, no new campaigns, and no bid strategy changes. Nobody touched anything. Walk me through your diagnostic process â what do you check, and in what order?',
    },
    p8_account_structure: {
      label: '8. Account Structure',
      phase: 'Account Structure & Diagnostics',
      question: 'How do you think about account structure in 2026? Single keyword ad groups, tightly themed ad groups, or heavy consolidation with broad match and smart bidding â where do you land, and what would actually determine your choice for this account specifically?',
    },
    p9_search_terms: {
    ...
    p14_shopping_feed: {
      ...
      question: "Northline's product feed uses the manufacturer's default titles, like 'Deluxe 28 SE'. Talk me through how you'd approach feed optimisation for this catalogue â titles, attributes, and how you'd use custom labels given what you now know about their margins.",
    },
    p15_pmax_setup: {
      label: '15. Performance Max Setup',
      phase: 'Shopping & Performance Max',
      question: "How do you set up and control a Performance Max campaign for this account? Cover asset groups, listing groups, search themes, audience signals, and brand exclusions â and tell me what you do about the parts of PMax you can't see.",
    },
    p16_pmax_cannibal: {
    ...
    p18_storm_seasonality: {
      ...
      phase: 'Bidding & Budget',
      question: 'Generator demand spikes hard and unpredictably â a major storm forecast can drive a 10x increase in search volume within 48 hours, and it collapses just as fast. How do you build the account and the budget process to capture that without blowing the monthly budget or wrecking your bid strategies?',
    },
    p19_budget_realloc: {
