...
window.ASSESSMENT_CATALOG = [
...

  {
    ...
    questions:  24,
    phases:     9,
    blurb:      'A single client engagement worked end to end — e-commerce, local, and national strategy, Google Business Profile and reputation management, forecasting, and executive communication. Your progress saves automatically.',
    status:     'live',
    accent:     '#8b5cf6',
  },
